...
I attempted to make a fully automated device to turn the sensor into a dashcam with an ESP32. Well, it kind of worked but the project very suffered from the poor performances of the Arduino IDE ESP library I used, despite the good theoretical properties of ESPs. So the project comes with a working code allowing you to build a 0.2 fps dashcam saving images in BMP on SD card. It can surely be improved but I prefered [moving on a Raspberry Pi Pico](https://github.com/Raphael-Boichot/Mitsubishi-M64282FP-dashcam) rather than continue on this platform for the moment. It can surely be improved by using the Espressif dev environement rather than the Arduino IDE.
