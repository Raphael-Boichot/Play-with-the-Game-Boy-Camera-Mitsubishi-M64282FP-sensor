...
## Known bugs
The registers are ignored during the first two pictures for unkown reason. The sensor boots systematically with default values set by the Arduino before taking values from the serial.
